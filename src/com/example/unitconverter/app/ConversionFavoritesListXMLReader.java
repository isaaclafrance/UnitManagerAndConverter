...
public class ConversionFavoritesListXMLReader extends AsyncTaskLoader<ArrayList<String>>{
	...
	private String favoritesXmlSource = "ConversionFavorites.xml";
		
	//Constructor 
	public ConversionFavoritesListXMLReader(Context context){
		super(context);
		this.isSourceOnline = false;
		favoritesXmlSource = "ConversionFavorites.xml";
	}
	...
	public ArrayList<String> loadInBackground() {
		...
		try {
			if(isSourceOnline){
				...
				conversionFavorites = loadFavoritesFromXML(getContext().openFileInput(favoritesXmlSource));
			}
