...
public class ConversionFavoritesListXMLWriter {
	//Fields
	private static String favoritesXmlDestination =  "ConversionFavorites.xml";
		
	//Constructor 
	public ConversionFavoritesListXMLWriter(Context context){
	}
	
	//Saves unit pairs involved in conversion into a XML file
	public static void saveToXML(Context context, ArrayList<String> favoritesConversions) throws XmlPullParserException, IllegalArgumentException, IllegalStateException, IOException{
		OutputStream xmlFileOutputStream = new FileOutputStream(context.getFilesDir().getPath().toString() + favoritesXmlDestination, false);
